...
const MobileSidebar = ({ isOpen, onClose }: MobileSidebarProps) => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent
        side="left"
        className="w-72 p-0 bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900"
      >
        <div className="h-full p-5 flex flex-col">
          <SheetHeader className="mb-8">
            <SheetTitle className="text-cyan-600 dark:text-cyan-400 font-bold text-xl tracking-wider text-left">
              MKD
            </SheetTitle>
          </SheetHeader>
